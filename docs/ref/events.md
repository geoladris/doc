Documentación de referencia de todos los eventos de los plugins. Pensar cómo organizar esto (por plugins, por eventos y decir qué plugins utilizan qué, con una tabla, etc.)
